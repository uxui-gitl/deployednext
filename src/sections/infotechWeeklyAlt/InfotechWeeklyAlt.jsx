          ...
          <div className="bg-blue-50 flex items-start flex-col justify-around ">
            <div>
              ...
              <p className="font-medium leading-[22px] md:w-[90%] ">
                Discover why our clients trust us and dive into our insights section. Empower your decision with the right knowledge and stay in the vanguard.
              </p>
            </div>
                      ...
                      <div className={`${styles["iw-card-content"]}`}>
                        ...
                        <p
                          className={`${styles["iw-card-content-desc"]
                            } text-clip  text-[#475467] text-sm ${cs.description.length <= 0 ? "hidden" : "block"
                            }`}
                        >
                          {`${cs.description}`}
                        </p>
