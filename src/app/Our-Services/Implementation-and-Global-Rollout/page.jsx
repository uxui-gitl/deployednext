...
const page = () => {
  return (
    <>
      <EntIntro
        title="Effective and Smooth Implementation to Elevate your Business Results  "
        desc="Our commitment is to make your transformation journey as smooth as possible, guaranteeing that you attain your ambitious results. That’s why we build a holistic viewpoint on your implementation and rollout project and assure that your project is on time, exceeding your expectations"
        cta="Let's Connect"
        width="60%"
