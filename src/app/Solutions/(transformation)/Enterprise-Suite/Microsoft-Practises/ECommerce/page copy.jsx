    ...
    <>
      ...
      <>
        ...
        <div className={`w-full  `}>
          <div className="  sm:flex-row h-full justify-center grid grid-cols-1 grid-rows-1 sm:grid-cols-3 sm:grid-rows-3 gap-0">
            <div className="bg-[#feeded] py-20 px-8 h-full row-span-1 sm:row-span-3 w-full   sm:flex-grow col-span-1 sm:col-span-1  ">
              <div className=" ">
                <Image
                  src={`/infor/infor.png`}
                  width={116}
            ...
            <>
              {eComCapabilities.map((item, index) => (
                <Link href={"/"} key={index}>
                  <div className="    col-span-1 row-span-1 flex border-[1px] flex-col justify-start sm:justify-center items-start sm:items-start h-full px-[2rem] p-4">
                    <div className=" ">
                      <Image
                        src={`/${item.icon}.png`}
                        height={36}
      ...
      <div className="grid my-32  max-w-screen-xl sm:max-w-screen-xl mx-auto col-span-1 grid-cols-1 sm:grid-cols-5 grid-rows-3  w-full">
        {eComCapabilities.map((item, index) => (
          <div key={index} className="mb-2" onClick={handleClick}>
        ...
        <div className="bg-img-ecom col-span-3 row-span-3 col-start-3 row-start-1 relative">
          <div className="absolute inset-0 bg-[#0745D3] bg-opacity-50 transition-opacity  ">
            <div className="absolute top-4 p-8 left-4 text-white ">
              {/* list and other of respective grid click goes here
               */}
              <h3 className="text-[30px] text-white w-fit leading-[42px] font-bold mb-5">
                Omnichannel Engagement
              </h3>
              <ul>
                <li className="border-b-[1px] mb-4 text-[14px] font-medium leading-[16px] pb-2">
                  Personalized Buying Experience: Immersive buying experience
                  across channels, uniting digital, in-store and back-office
                  operations on a unified platform.
                </li>
                <li className="border-b-[1px] mb-4 text-[14px] font-medium leading-[16px] pb-2">
                  Consistent Customer Engagement: Hassle-free engagement,
                  allowing customers to choose when, how and where they
                  purchase.
                </li>
                <li className="border-b-[1px] mb-4 text-[14px] font-medium leading-[16px] pb-2">
                  Flexible Purchase Options: Freedom to select preferred method,
                  facilitating integrated ordering and fulfilment.
                </li>
                <li className="border-b-[1px] mb-4 text-[14px] font-medium leading-[16px] pb-2">
                  Efficient Sales Promotions: Centrally manage and oversee sales
                  promotions across channels with real-time data.
                </li>
                <li className="mb-4 text-[14px] font-medium leading-[16px] pb-2">
                  Enhanced B2B Engagement: Tailored functionality for B2B
                  organizations and self-service purchasing experiences.
                </li>
              </ul>
            </div>
          </div>
